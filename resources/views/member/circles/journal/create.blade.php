<x-layouts.member :title="'Nouvelle entrée — '.$circle->name.' — La Fabrique'">

<div class="ea-topbar">
    <h1 class="ea-greeting">Nouvelle entrée — {{ $circle->name }}</h1>
...
<div style="background:var(--surface-raised);border:1px solid var(--border-subtle);border-radius:10px;padding:28px 32px;max-width:640px;">
    ...
    <form method="POST" action="{{ route('member.circles.journal.store', $circle) }}">
        @csrf
        ...
        <div style="display:flex;gap:10px;justify-content:flex-end;">
            ...
            <button type="submit" class="fb-btn fb-btn-primary fb-btn-sm">Enregistrer l'entrée</button>
        </div>
    </form>
</div>
