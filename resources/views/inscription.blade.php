...
<section style="max-width:720px;margin:64px auto;padding:0 24px;">
    ...
    <p class="fb-lead" style="margin-bottom:40px;">
        ...
        On vous envoie un lien pour finaliser votre inscription — pas de mot de passe.
    </p>
    ...
    <form method="POST" action="{{ route('inscription.store') }}">
        ...
        <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;">
            <button type="submit" class="fb-btn fb-btn-primary fb-btn-lg">Recevoir mon lien →</button>
