        ...
        <tr>
          <td style="background:#ffffff;padding:40px;border-left:1px solid #efe4cb;border-right:1px solid #efe4cb;">
            ...
            <p style="font-size:16px;line-height:1.6;color:#2b2517;margin:0 0 24px;">
              ...
              souhaite rejoindre le cercle <strong>{{ $membership->circle->name }}</strong>.
            </p>
            <table cellpadding="0" cellspacing="0" style="background:#fdfaf3;border:1px solid #efe4cb;border-radius:8px;padding:16px 20px;margin-bottom:32px;width:100%;">
              <tr>
                <td style="font-size:13px;color:#6f6553;padding-bottom:6px;">Nom</td>
                <td style="font-size:14px;color:#1d1a10;padding-bottom:6px;">{{ $membership->user->name ?: '—' }}</td>
              </tr>
              <tr>
                <td style="font-size:13px;color:#6f6553;padding-bottom:6px;">Email</td>
                <td style="font-size:14px;color:#1d1a10;padding-bottom:6px;">{{ $membership->user->email }}</td>
              </tr>
              <tr>
                <td style="font-size:13px;color:#6f6553;">Cercle</td>
                <td style="font-size:14px;color:#1d1a10;">{{ $membership->circle->name }}</td>
              </tr>
            </table>
