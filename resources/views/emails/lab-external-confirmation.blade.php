...
<title>Votre demande au Lab a bien été reçue</title>
</head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#8e3217;border-radius:14px 14px 0 0;padding:32px 40px;text-align:left;">
            ...
            <div style="font-size:12px;color:#e89a78;margin-top:4px;letter-spacing:.08em;text-transform:uppercase;">Lab · Confirmation de demande</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#ffffff;padding:40px;border-left:1px solid #efe4cb;border-right:1px solid #efe4cb;">
            <p style="font-family:Georgia,serif;font-size:24px;line-height:1.25;color:#1d1a10;margin:0 0 16px;">
              Bonjour {{ $externalRequest->nom_contact }},
            </p>
            <p style="font-size:16px;line-height:1.6;color:#2b2517;margin:0 0 16px;">
              Votre demande au Lab La Fabrique a bien été reçue. Nous allons l'étudier et vous recontacterons dans les meilleurs délais.
            </p>
            <p style="font-size:15px;line-height:1.6;color:#2b2517;margin:0 0 24px;">
            ...
            <div style="background:#fdfaf3;border:1px solid #efe4cb;border-radius:8px;padding:16px 20px;margin-bottom:32px;">
              <div style="font-size:13px;color:#6f6553;margin-bottom:6px;">Votre message</div>
              <div style="font-size:14px;color:#1d1a10;line-height:1.6;">{{ $externalRequest->message }}</div>
            </div>
            <p style="font-size:14px;line-height:1.6;color:#6f6553;margin:0 0 8px;">
              En cas de question, répondez directement à cet email.
            </p>
            <p style="font-size:14px;line-height:1.6;color:#6f6553;margin:0;">
              À bientôt,<br>
              <strong style="color:#1d1a10;">L'équipe du Lab La Fabrique</strong>
            </p>
          </td>
        </tr>
