...
<title>Compte-rendu publié</title>
</head>
        ...
        <tr>
          <td style="background:#ffffff;padding:40px;border-left:1px solid #efe4cb;border-right:1px solid #efe4cb;">
            <p style="font-family:Georgia,serif;font-size:24px;line-height:1.25;color:#1d1a10;margin:0 0 16px;">
              Compte-rendu publié — {{ $meeting->circle->name }}
            </p>
            <p style="font-size:16px;line-height:1.6;color:#2b2517;margin:0 0 24px;">
              Le compte-rendu de la réunion <strong>{{ $meeting->title }}</strong> est maintenant disponible.
            </p>
            <table cellpadding="0" cellspacing="0" style="background:#fdfaf3;border:1px solid #efe4cb;border-radius:8px;padding:16px 20px;margin-bottom:32px;width:100%;">
              <tr>
                <td style="font-size:13px;color:#6f6553;padding-bottom:6px;white-space:nowrap;padding-right:16px;">Réunion</td>
                <td style="font-size:14px;color:#1d1a10;padding-bottom:6px;font-weight:600;">{{ $meeting->title }}</td>
              </tr>
              <tr>
                <td style="font-size:13px;color:#6f6553;padding-bottom:6px;white-space:nowrap;padding-right:16px;">Cercle</td>
                <td style="font-size:14px;color:#1d1a10;padding-bottom:6px;">{{ $meeting->circle->name }}</td>
              </tr>
              <tr>
                <td style="font-size:13px;color:#6f6553;white-space:nowrap;padding-right:16px;">Date de réunion</td>
                <td style="font-size:14px;color:#1d1a10;">{{ $meeting->scheduled_at->translatedFormat('D d M Y à H\hi') }}</td>
              </tr>
            </table>
