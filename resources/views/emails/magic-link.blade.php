        ...
        <tr>
          <td style="background:#ffffff;padding:40px;border-left:1px solid #efe4cb;border-right:1px solid #efe4cb;">
            ...
            <p style="font-size:16px;line-height:1.6;color:#2b2517;margin:0 0 32px;">
              Voici votre lien de connexion à l'espace adhérent de La Fabrique.
            ...
            <p style="font-size:13px;color:#6f6553;margin:24px 0 0;line-height:1.5;">
              ...
              <span style="word-break:break-all;color:#b1411c;">{{ $url }}</span>
            </p>
            <p style="font-size:13px;color:#6f6553;margin:16px 0 0;">
