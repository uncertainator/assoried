...
<div style="max-width:720px;margin:0 auto;padding:48px 24px;">
    ...
    <form id="form-citoyen" method="POST" action="{{ route('lab.external.citoyen.store') }}"
        ...
        <div style="margin-bottom:20px;">
            <label for="type_projet" style="display:block;font-size:var(--text-sm);font-weight:500;color:var(--fg-primary);margin-bottom:6px;">
